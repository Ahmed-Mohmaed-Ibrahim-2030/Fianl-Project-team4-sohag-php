      ...
      {{  method_field('post')}}
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="last_name" placeholder="" value="{{old('first_name')}}">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label> scientific_degree </label>

                    <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-scientific_degree"></i></span>
                    </div>
                    <input type="text" class="form-control" name="scientific_degree" value="{{old('scientific_degree')}}">
                </div>
                <!-- /.input group -->
            </div>
            <div class="form-group">
