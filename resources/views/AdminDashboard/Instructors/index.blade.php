        ...
        <div class="form-group">
            <div class="row ">
                ...
                <div class="col-md-4">
                    ...
                    <a href="{{route('instructors.create')}}" class="btn btn-primary  {{Auth::user()->hasPermission('users-create')?'':'disabled'}}"><i class="fa fa-plus"></i> Add</a>
                </div>
            </div>
        </div>
    </form>
    <div class="card">
        <div class="card card-dark">
            <div class="card-header">
                <h3 class="card-title">List all Instructors</h3>
            </div>
